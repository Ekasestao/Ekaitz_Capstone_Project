  ...
  render() {
    return (
      <div className="paypal-login-wrapper">
        ...
        <p>
          Aviso Importante: Esto es una simulación con fines de entrenamiento o
          trabajo y no está afiliado a PayPal u otra entidad financiera real.
          Los datos ingresados aquí no se almacenan ni se utilizan con fines
          comerciales. Por favor, no introduzca información real de inicio de
          sesión o datos sensibles. Con introducir un correo o teléfono y
          contraseña ficiticios funciona.
        </p>
      </div>
    );
  }
